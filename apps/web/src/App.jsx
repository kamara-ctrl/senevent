...
const evenementsFiltres = recherche === "" 
    ? evenements 
    : evenements.filter(ev => ev.titre.toLowerCase().includes(recherche.toLowerCase()));
  ...
  return (
    <div className={styles.container}>
      ...
      <p className={styles.compteur}>{evenementsFiltres.length} evenement(s) trouve(s)</p>
